...
\begin{itemize}
	...
	\begin{itemize}
	    \small
		\item Anonymous (2007), Greg Brill, Paul Kiedrowski, Steven Manzer, Barry Ward, Ward Elder, Art Eckstein, World of ElectroMechanica, Austin Valley Software Corporation, webstudio.co.uk, Juan Posada
	\end{itemize}
\end{itemize}
