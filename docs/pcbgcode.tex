...
\begin{description}
	...
	\begin{description}
		...
		\end{description}
		\item[Etching Tool Size] The size of the cutter used to cut around tracks on the board. Note that this setting is also found under the Machine tab as the etching tool diameter, as seen in Figure \vref{fig:SetupMachine}.
	\end{description}
\end{description}
