...
\code{Offset gcode} allows an amount to be added to all the coordinates generated by pcb-gcode. This is useful if, for example, multiple etch files are being combined into a single file.\index{offset!gcode}
