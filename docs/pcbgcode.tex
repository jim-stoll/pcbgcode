...
\fontsize{18pt}{10pt}\textsc{Version 3.6.2.1}\\[1em]
}
...
\begin{itemize}
	...
	\begin{itemize}
    	\raggedright
		\item Anonymous (2007), Greg Brill, Paul Kiedrowski, Steven Manzer, Barry Ward, Ward Elder, Art Eckstein, World of ElectroMechanica, Austin~Valley~Software~Corporation, webstudio.co.uk, Juan Posada, Richard~McCarthy, Keeley~Electronics, Ron Watson, Andrew Mackenzie
	\end{itemize}
